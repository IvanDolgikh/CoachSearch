        ...
        <div class="coach__info-container">
            ...
            <div class="coach__info info">
                <div class="info__rating-container">
                    <p class="info__fio">{{ data.fullName }}</p>

                    <div class="info__like-container">
                        <button class="info__like-button coach_button_liked" @click="addLike(data.trainerId)">
                    ...
                    <div class="info__comment-container">
                        ...
                        <span class="info__comment-amout">16</span>
                    </div>

                </div>
                <p class="info__tel">Тел: <strong>{{ data.phoneNumber }}</strong></p>
                <p class="info__email">Эл почта: <strong>{{ data.email }}</strong></p>
                <p class="info__about-title">О себе:</p>
                <p class="info__about">{{ data.info }}</p>
                <p class="info__specialization">Специализация: <strong>{{ data.specialization }}</strong></p>
...
const url = 'http://localhost:5161/api/trainer'
